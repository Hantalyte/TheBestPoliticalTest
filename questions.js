questions =  [
    {"id": 0, "question": "Freedom of business is lowkey the best practical way a society can do good or whatever.", "effects": {"right": 1}},
    {"id": 1, "question": "Private charity > social welfare", "effects": {"right": 1}},
    {"id": 2, "question": "Wages = always fair b/c employers know best", "effects": {"right": 1}},
    {"id": 3, "question": "It is \"human nature\" to be greedy little bitches.", "effects": {"right": 1}},
    {"id": 4, "question": "\"Exploitation\" is an unc term and doesn't exist no more", "effects": {"right": 1}},
    {"id": 5, "question": "Communism never works irl", "effects": {"right": 1}},
    {"id": 6, "question": "Taxation of the wealthy = bad", "effects": {"right": 1}},
    {"id": 7, "question": "Work hard -> you climb the ladder", "effects": {"right": 1}},
    {"id": 8, "question": "Orgs and Corps are too deceitful and need to be regulated by the daddy Trump.", "effects": {"right": -1}},
    {"id": 9, "question": "A government that provides for everyone is an inherently bien idea.", "effects": {"right": -1}},
    ...
    {"id": 17, "question": "Being able to compell a government's citizens to do things is important.", "effects": {"auth": 1}},
    ...
    {"id": 24, "question": "Without liberal democracy, government sucks.", "effects": {"auth": -1}},
